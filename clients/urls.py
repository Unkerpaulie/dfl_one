...
urlpatterns = [
    ...
    path('i/<int:client_id>/beneficiaries/', views.edit_i_beneficiary, name="edit_i_beneficiary"),
    path('c/<int:client_id>/beneficiaries/', views.edit_c_beneficiary, name="edit_c_beneficiary"),
